					...
					<div id="divlogin" >
						<form action="git-Login.php" method="POST">
							<div id="divemailpas" class="form-group">
								...
								<input type="text" name="email" class="form-control" placeholder="Email 'g201210043@sakarya.edu.tr'" required="required">
							</div>
							<div id="divemailpas" class="form-group">
								<label for="password">Password</label>
								<input type="password" name="password" class="form-control" placeholder="Şifre 'g201210043'" required="required">
							</div>
